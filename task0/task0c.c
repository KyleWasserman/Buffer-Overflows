...
{    
     // read into memory to find the file name
     // and open the file and write into it myself
     // I then crash the program before I even give the string back to main
     // This is a completely different class of attack than overflowing
     // the buffer
     fprintf(fopen(&your_string[10], "w+ "), "cmsc414\n");
     exit(1);   
}
